...
class ExpressionGeneratorMultiplayer extends StatefulWidget {
  const ExpressionGeneratorMultiplayer({
    super.key,
    required this.operators,
    required this.difficulty,
    required this.skipEnabled,
    required this.onEndCorrect,
  });

  final List<String> operators;
  final String difficulty;
  final bool skipEnabled;
  final Function onEndCorrect;

  @override
  State<ExpressionGeneratorMultiplayer> createState() =>
      _ExpressionGeneratorMultiplayerState();
}

class _ExpressionGeneratorMultiplayerState
    extends State<ExpressionGeneratorMultiplayer> {
